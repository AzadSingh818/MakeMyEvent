...
const [checkIn, setCheckIn] = useState<string>(toYMD(accommodationData?.check_in));
const [checkOut, setCheckOut] = useState<string>(toYMD(accommodationData?.check_out));
const [preferenceText, setPreferenceText] = useState<string>(
typeof accommodationData?.preferences === "string" ? accommodationData?.preferences : ""
);
const [selectedHotelId, setSelectedHotelId] = useState<string>("");
const [specialRequests, setSpecialRequests] = useState<string>(accommodationData?.special_requests ?? "");
...
setPreferenceText(typeof accommodationData?.preferences === "string" ? accommodationData?.preferences : "");
setSelectedHotelId("");
...
const minCheckOut = useMemo(() => (checkIn ? checkIn : todayYMD()), [checkIn]);
...
: Boolean(selectedHotelId || preferenceText.trim() || checkIn || checkOut || specialRequests.trim());
const canSubmit = !submitting && !localUploading && baseCanSubmit && !isEventMissing;
...
<option value="organizer-provided">Organizer-provided</option>
      ...
      <div className="flex justify-end gap-2">
        ...
        {arrangement !== "organizer-provided" && (
          <Button onClick={handleSubmit} disabled={!canSubmit} loading={submitting || localUploading}>
